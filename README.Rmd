...
The goal of toyRpackage is to make regular expressions more exciting!
...
You can install the development version of toyRpackage from [GitHub](https://github.com/) with:
